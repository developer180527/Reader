...
export function Library({ onOpenBook }: { onOpenBook: (id: string) => void }) {
  ...
  return (
    <div className="h-full overflow-y-auto bg-[#0A0A0A] text-gray-200 p-6 pt-12 sm:p-10 font-sans">
      <header className="max-w-5xl mx-auto flex flex-col md:flex-row md:items-center justify-between gap-4 mb-10 h-16 bg-[#121212] border-b border-white/5 px-8 rounded-2xl shadow-xl">
        <h1 className="text-sm font-semibold tracking-widest uppercase opacity-60">Library</h1>
